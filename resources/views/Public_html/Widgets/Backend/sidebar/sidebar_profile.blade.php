<div class="card card-primary card-outline">
    <div class="card-body box-profile">
        <div class="text-center">
            <img class="profile-user-img img-fluid img-circle" src="{{$user->user_profile->img}}" alt="User profile picture">
...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <p class="text-muted">{{$user->user_profile->address}}</p>
        <hr>
        <strong><i class="fas fa-pencil-alt mr-1"></i> Skills</strong>
        <p class="text-muted">
            {!! html_entity_decode($user->user_profile->skill) !!}
        </p>
        <hr>
        <strong><i class="far fa-file-alt mr-1"></i> Notes</strong>
        <p class="text-muted">{!! html_entity_decode($user->user_profile->notes) !!}</p>
    </div>
    <!-- /.card-body -->
</div>