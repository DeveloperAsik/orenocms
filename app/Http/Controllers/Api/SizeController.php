...
class SizeController extends Controller {
    ...
    public function get_list(Request $request) {
        ...
        $data = DB::table('tbl_b_sizes AS a')
                ->select('a.id','a.name AS size_name','b.id AS size_type_id','b.name AS size_type_name')
                ->leftJoin('tbl_b_size_types AS b', 'b.id', '=', 'a.product_id')
                ->offset($offset)
                ->limit($limit)
                ->get();
