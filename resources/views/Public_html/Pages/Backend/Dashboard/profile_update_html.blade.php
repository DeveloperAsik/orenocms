                            ...
                            <div class="active tab-pane" id="details">
                                <form class="form-horizontal" id="form-detail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" name="email" value="{{$user->user_profile->email}}" class="form-control" id="inputEmail" placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group change_password">
                                        <label for="new_password2" class="col-sm-2 control-label">Re Type Password</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="new_password2" placeholder="Re Type new Password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
